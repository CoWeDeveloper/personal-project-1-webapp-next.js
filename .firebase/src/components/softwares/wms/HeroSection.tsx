...
export default function HeroSection() {
  return (
    ...
    transition-all g-no-repeat bg-cover flex items-center '
       style={{ backgroundImage: `url("/assets/images/Software/Wms/wmsbanner.webp")` }} >
      <div className='mx-auto max-w-screen-lg lg:px-20 md:px-16 sm:px-5 text-center'>
        <h1  className={` drop-shadow-2xl text-white font-black text-5xl mb-4`} >The Smart Solution For Your Warehouse Needs.</h1>
