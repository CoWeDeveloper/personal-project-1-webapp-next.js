...
import banner from "../../../../public/assets/images/Software/Primary/primsubbanner.png"
import { primaryData } from "@/data/primaryData";

function PrimaryInfo() {
  return (
    <div id="PrimarInfo" className="w-full h-fit bg-white pt-14 pb-10">
