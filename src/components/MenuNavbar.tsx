        ...
        >
          <div className="relative cursor-pointer top-10 left-[90%]">
            ...
            <ul className='relative flex flex-col text-white md:text-xl sm:text-2xl xs:text-xl font-medium sm:pt-32 xs:pt-32 sm:pb-20 xs:pt-28 md:gap-1 sm:gap-2 xs:gap-1'>
                ...
                <Link href={'/softwares'} className='hover:text-white drop-shadow-xl active:hover:text-white'><li>Softwares</li></Link>
                <Link href={'/customers'} className='hover:text-white drop-shadow-xl active:hover:text-white'><li>Customers</li></Link>
                <Link href={'/'} className='hover:text-white drop-shadow-xl active:hover:text-white'><li>Alliances</li></Link>
                <Link href={'/'} className='hover:text-white drop-shadow-xl active:hover:text-white'><li>Careers</li></Link>
                <Link href={'/'} className='hover:text-white drop-shadow-xl active:hover:text-white'>
