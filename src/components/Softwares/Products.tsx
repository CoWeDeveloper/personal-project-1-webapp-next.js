...
// import data
import {softwareData} from "../../data/softwareData.ts";
...
//     <div key={cards.id} className="w-full flex flex-wrap mx-auto justify-center" >
//       <div className={` w-full lg:w-[55%] ${cards.id % 2 === 0 ? 'order-1' : 'order-0'} `} >
//       <Image
//         className="w-40"
//         src={cards.img}
//         width={120}
...
//     </div>
//     {index < cards.length - 1 && cards[index + 1].id === cards.id + 1 && (
