    ...
    <section className='w-full h-fit bg-white'>
       <div className='max-w-screen-lg py-10 mx-auto'>
        ...
        <div className='flex justify-between'>
          ...
          <div className="flex justify-center items-center mb-4">
             <div className="relative w-full mr-4">
             <input id="country" name="country" placeholder=" " className="block px-2.5 pb-2.5 pt-4 mr-4 w-full text-sm text-gray-400 bg-transparent rounded-lg border-2 border-gray-400 focus:ring-0 focus:border-gray-900 peer focus:outline-none " type="text" />
             ...
             <div className="relative w-full">
             <input id="contact" name="contact" placeholder=" " className="block px-2.5 pb-2.5 pt-4 mr-4 w-full text-sm text-gray-400 bg-transparent rounded-lg border-2 border-gray-400 focus:ring-0 focus:border-gray-900 peer focus:outline-none " type="text" />
          ...
          <div className="flex justify-center items-center mb-4">
             <div className="relative w-full mr-4">
             <input id="company" name="company" placeholder=" " className="block px-2.5 pb-2.5 pt-4 mr-4 w-full text-sm text-gray-400 bg-transparent rounded-lg border-2 border-gray-400 focus:ring-0 focus:border-gray-900 peer focus:outline-none " type="text" />
             ...
             <div className="relative w-full">
             <input id="industry" name="industry" placeholder=" " className="block px-2.5 pb-2.5 pt-4 mr-4 w-full text-sm text-gray-400 bg-transparent rounded-lg border-2 border-gray-400 focus:ring-0 focus:border-gray-900 peer focus:outline-none " type="text" />
          ...
          <div >
          <div className="relative w-full">
             <input id="message" name="message" placeholder=" " className="block resize-none h-[190px] px-2.5 pb-2.5 pt-4 mr-4 w-full text-sm text-gray-400 bg-transparent rounded-lg border-2 border-gray-400 focus:ring-0 focus:border-gray-900 peer focus:outline-none " type="text" />
